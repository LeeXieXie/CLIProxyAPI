...
type Config struct {
	...
	// UsageRetentionDays controls how many days of request details are kept in the SQLite database.
	// Rows older than this value are pruned on every flush. 0 means use the default (90 days).
